...
void print_usage(const char* prog)
{
    std::cout
        ...
        << "MQTT Last Will and Testament ([mqtt] will_*):\n"
        << "  --mqtt-will-topic <str>    LWT topic (default: <topic>/status)\n"
        << "  --mqtt-will-payload <str>  LWT payload (default: {\"status\":\"offline\"})\n"
        << "  --mqtt-will-qos <0|1|2>    LWT QoS level (default: 0)\n"
        << "  --mqtt-will-retain         Publish LWT with retain flag\n\n"
        << "Storage ([storage]):\n"
        << "  --output <file>            CSV output path (default: auto)\n"
        << "  --storepath <dir>          Directory for auto-generated CSV files\n"
        << "                             Created automatically if it does not exist\n"
        << "  --buf <int>                Ring buffer capacity (default: 4096)\n"
        << "  --flush-ms <int>           Flush interval ms (default: 500)\n"
        << "  --csv-sep <char>           CSV column separator (default: ;)\n\n"
        << "Logging ([logging]):\n"
        << "  --log <path>               Log file (stderr|stdout|default|<path>)\n"
        << "  --no-log-stderr            Do not duplicate log to stderr\n"
